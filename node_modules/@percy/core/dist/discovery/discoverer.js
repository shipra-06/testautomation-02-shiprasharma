    ...
    return async request => {
      ...
      try {
        if (url === rootUrl) {
          ...
          (0, _assert.default)((0, _url.hostnameMatches)(rootHost, url) || (0, _url.hostnameMatches)(allowedHostnames, url) || (0, _url.hostnameMatches)(this.config.allowedHostnames, url), 'is remote', meta);
